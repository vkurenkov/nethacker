    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            def recover_hitpoints():
                # hypothesis: resting in cleared terrain below 80% HP prevents post-fight attrition from turning recovery exploration into another lethal encounter.
                if self.agent.blstats.hitpoints >= 0.8 * self.agent.blstats.max_hitpoints:
                    yield False
                yield True
                self.agent.search()
