    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: descend after reaching level 7 to avoid overfarming the first floor,
                # improving depth and reducing starvation or combat deaths across both identities.
