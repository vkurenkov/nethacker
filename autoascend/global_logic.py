    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: a hungry, foodless Samurai is as durable as a Valkyrie and should trade otherwise-certain level-one starvation for productive dungeon descent.
                condition = lambda: self.agent.blstats.experience_level >= 8 or (
                    self.agent.character.role in (Character.VALKYRIE, Character.SAMURAI) and
