    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                ...
                # hypothesis: Tourists reaching XL7 should descend before level-one farming exhausts their darts and food, while retaining more preparation than the rejected XL5 exit.
                condition = lambda: (
                    self.agent.character.role == Character.TOURIST and
                    self.agent.blstats.experience_level >= 7
                ) or self.agent.blstats.experience_level >= 8 or (
