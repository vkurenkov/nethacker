    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: ending level-one XP farming once a foodless character becomes hungry trades imminent shallow starvation for fresh food and progress on deeper levels.
