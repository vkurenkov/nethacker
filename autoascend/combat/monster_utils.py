...
# hypothesis: treating slow contact hazards as ranged-only lets Valkyries use their starting dagger instead of risking run-ending petrification, sliming, or passive acid damage in melee.
ONLY_RANGED_SLOW_MONSTERS = ['floating eye', 'blue jelly', 'brown mold', 'spotted jelly', 'gas spore', 'acid blob',
                             'chickatrice', 'cockatrice', 'green slime']
