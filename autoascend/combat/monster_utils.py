...
HIGH_DAMAGE_MONSTERS = ['rabid rat', 'wererat', 'rothe', 'white unicorn', 'hill orc', 'sasquatch',
                        'jaguar', 'dingo', 'iguana']
...
def is_dangerous_monster(monster):
    ...
    return is_pet or mon.mname in INSECTS or mon.mname in HIGH_DAMAGE_MONSTERS
